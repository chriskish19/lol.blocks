...
dx11::simple_tx_demo::simple_tx_demo(HWND handle, UINT width, UINT height)
{
	HRESULT hr = CoInitializeEx(nullptr, COINIT_MULTITHREADED);
	st_vs_out(hr);
...
dx11::simple_tx_demo::~simple_tx_demo()
{
	if (m_p_dd != nullptr) {
		delete m_p_dd;
		m_p_dd = nullptr;
...
lb::codes dx11::simple_tx_demo::load_content()
{
	// make a sprite batch
...
void dx11::simple_tx_demo::unload_content()
{
}

void dx11::simple_tx_demo::update(float dt)
{
}

void dx11::simple_tx_demo::render()
{
...
dx11::camera_demo::camera_demo(HWND handle, UINT width, UINT height)
{
	// init direct xtk
	HRESULT hr = CoInitializeEx(nullptr, COINIT_MULTITHREADED);
	st_vs_out(hr);
...
lb::codes dx11::camera_demo::load_content()
{
	DWORD shaderFlags = D3DCOMPILE_ENABLE_STRICTNESS;
...
void dx11::camera_demo::unload_content()
{
}

void dx11::camera_demo::update(float dt)
{
...
lb::codes dx11::cube_demo::load_content()
{
	DWORD shaderFlags = D3DCOMPILE_ENABLE_STRICTNESS;
