...
main_lol_blocks_exe::window_create::window_create(const std::wstring& title) noexcept
    :m_title(title)
{
    window_settings();
...
utilities::lolblock_ec::codes main_lol_blocks_exe::window_create::build_menu_bar() noexcept
{
    ...
    SetMenu(this->m_main_window_handle, hMenu);
...
main_lol_blocks_exe::window_relative::window_relative(const std::wstring& c_name,const std::wstring& title, HINSTANCE hinst, HWND main_handle) noexcept
{
